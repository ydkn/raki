ActionController::Routing::Routes.draw do |map|
  ...
  map.connect 'wiki/:page.(:format)/:revision', :controller => 'page', :action => 'view'
  map.connect 'wiki/:page.(:format)', :controller => 'page', :action => 'view'
  ...
  map.root :controller => 'page', :action => 'show', :id => Raki.frontpage
